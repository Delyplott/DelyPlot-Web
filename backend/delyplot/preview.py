...
def generate_preview_pdf(input_pdf: str, output_pdf: str, order_id: str, analysis: Dict[str, Any]) -> None:
  ...
  # ✅ FIX: ReportLab drawImage no acepta BytesIO directamente.
  # Debe ir envuelto con ImageReader.
  c.drawImage(ImageReader(buff), 0, 0, width=w_pt, height=h_pt, mask="auto")
